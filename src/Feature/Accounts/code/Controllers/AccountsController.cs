namespace Sitecore.Feature.Accounts.Controllers
{
    ...
    public class AccountsController : Controller
    {
        ...
        {
            this.AccountRepository = new AccountRepository(null, null);
        }
        ...
        private LoginInfo CreateLoginInfo(string returnUrl = null)
        {
            ...
            {
                ReturnUrl = returnUrl,
                LoginButtons = null//this.FedAuthLoginRepository.GetAll()
            };
        }
        ...
        //protected async Task<ActionResult> Login(LoginInfo loginInfo, Func<string, ActionResult> redirectAction)
        {
            ...
            var redirectUrl = string.IsNullOrEmpty(loginInfo.ReturnUrl) ? "/" : loginInfo.ReturnUrl;
